...
async function speak(text: string, lang: LanguageCode) {
  ...
  const thisAbort = currentSpeakAbort;
  try {
    ...
    if (thisAbort.signal.aborted) {
      console.log('TTS request was aborted during fetch');
      return;
    }
    ...
    audio.onended = () => {
      ...
      if (currentAudio === thisAudio) currentAudio = null;
    };
    audio.onerror = (e) => {
    ...
    if (currentSpeakAbort === thisAbort) currentSpeakAbort = null;
  }
}
